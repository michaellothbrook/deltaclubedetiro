    		...
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
	    				...
	    				<div class="img img-video d-flex align-self-stretch align-items-center" style="background-image:url(images/logo.jpg);">
	    					<div class="video justify-content-center">
									<a href="<?=base_url('assets/video/deltaclubedetiro.mp4')?>" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
				...
				<div class="row mt-5 " style="">
					...
					<!-- <div class="col-6 text-left">
						<div class="img-responsive">
							<img style="width: 100%;max-height: 50vh" src="<?=base_url('images/logo.jpg')?>" alt="">
						</div>
					</div> -->
					<div class="col-md-6 col-12">
          ...
          <div class="col-md-4 col-12 d-flex ftco-animate">
          	<div class="align-self-stretch box text-center p-4">
          		...
          		<div>
		            ...
		            <p>Av Elias Antonio Issa, Nº 321 D - Leticia, Belo Horizonte - MG</p>
		          </div>
	          </div>
          </div>
          <div class="col-md-4 col-12 d-flex ftco-animate">
