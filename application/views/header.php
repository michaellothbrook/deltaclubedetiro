...
<html lang="en">
  <head>
	...
	<?php foreach($assets['header']['iconic'] as $iconics): ?>
		<link rel="stylesheet" href="<?=base_url('assets/css/bootstrap/open-iconic-master/font/css/').$iconics;?>">
	<?php endforeach ?>	
...
<header>
  	...
  	<nav id="navbar" class="navbar">
		...
		<!-- Start Home Section -->
		<section id="home" class="hero-wrap js-fullheight" style="background-image: url(images/bg-1-.jpg);background-position: center center;background-repeat:no-repeat;" >
